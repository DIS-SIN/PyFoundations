...
class DOLPageUserProfileUpdate extends React.Component {
    constructor(props) {
        super(props);
    }
...
DOLPageUserProfileUpdate.propTypes = {
    classes: PropTypes.object.isRequired,
};

// connect redux state
export default connect(mapStateToProps)(withStyles(styles)(DOLPageUserProfileUpdate));
