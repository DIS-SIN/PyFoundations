...
class DOLPageUserProfileEdit extends React.Component {
    constructor(props) {
        super(props);
    }
...
DOLPageUserProfileEdit.propTypes = {
    classes: PropTypes.object.isRequired,
};

// connect redux state
export default connect(mapStateToProps)(withStyles(styles)(DOLPageUserProfileEdit));
