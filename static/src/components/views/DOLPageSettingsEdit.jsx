...
class DOLPageSettingsEdit extends React.Component {
...
DOLPageSettingsEdit.propTypes = {
    classes: PropTypes.object.isRequired,
};

// connect redux state
export default connect(mapStateToProps)(withStyles(styles)(DOLPageSettingsEdit));
