...
class DOLPageModifyExperience extends React.Component {
...
DOLPageModifyExperience.propTypes = {
    classes: PropTypes.object.isRequired,
};

// connect redux state
export default connect(mapStateToProps)(withStyles(styles)(DOLPageModifyExperience));
