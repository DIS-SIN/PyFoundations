...
class DOLPageModifyEpisode extends React.Component {
...
DOLPageModifyEpisode.propTypes = {
    classes: PropTypes.object.isRequired,
};

// connect redux state
export default connect(mapStateToProps)(withStyles(styles)(DOLPageModifyEpisode));
