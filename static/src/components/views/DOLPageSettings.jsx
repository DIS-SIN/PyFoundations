...
class DOLPageSettings extends React.Component {
    ...
    render() {
        ...
        const link_group_hero = [
            ...
            { "href": "/settings/edit", "title": literals.common.edit },
        ];
        return (
            <React.Fragment>
                <CssBaseline />
...
DOLPageSettings.propTypes = {
    classes: PropTypes.object.isRequired,
};

// connect redux state
export default connect(mapStateToProps)(withStyles(styles)(DOLPageSettings));
